...
import { ConstantContent, IContent } from '@sensenet/client-core'
                        ...
                        <ContentList
                            ...
                            onItemClick={(ev, content) => {
                                if (ev.ctrlKey) {
                                    ...
                                    const activeIndex = this.props.active && this.props.items.d.results.findIndex((s) => s.Id === (this.props.active as IContent).Id) || 0
