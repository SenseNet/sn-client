...
class UserSearch extends React.Component<UserSearchProps & WithStyles<C>, {}> {
  constructor(props: UserSearch['props']) {
    super(props)
...
export default withStyles(styles as any)(UserSearch)
