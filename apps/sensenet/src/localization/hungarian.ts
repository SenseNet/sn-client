...
const values: DeepPartial<typeof import('./default').default> = {
  ...
  settings: {
    ...
    apiEndPointSelect: 'Válassza ki a technológiáját a megfelelő végpont megtalálásához',
    apiEndPointApi: 'API végpont:',
    apiEndPointIs: 'Identity Server url:',
    downloadSdk: 'SDK letöltése',
    sdkText: 'Natív SDK-t kínálunk kedvenc technológiájához',
    sdkText2: 'Az SDK kezeli a gyorsítótárat, az előnézetet, az A/B tesztet stb. ',
