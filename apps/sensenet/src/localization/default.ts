const values = {
  ...
  settings: {
    ...
    apiEndPointSelect: 'Select your technology to find the right endpoint',
    apiEndPointApi: 'Use this endpoint for your API access:',
    apiEndPointIs: 'Use this as your Identity Server access:',
    downloadSdk: 'Download the SDK for your technology here',
    sdkText: 'We provide native SDK for your favourite technlogy',
    sdkText2: 'Those SDK handle caching, preview, A/B testing etc. ',
