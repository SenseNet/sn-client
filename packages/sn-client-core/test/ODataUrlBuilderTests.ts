...
export const oDataUrlBuilderTests = describe("ODataUrlBuilder", () => {
    ...
    describe("#buildUrlParamString()", () => {
        ...
        it("should return a string with the given parameters", () => {
            const urlParamString = ODataUrlBuilder.buildUrlParamString<GenericContent>({requiredSelect: ["Id", "Type"], defaultMetadata: "no"} as any, { select: ["DisplayName", "Path"], orderby: "DisplayName", query: "isOf('Article')" });
