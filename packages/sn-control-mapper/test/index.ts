...
export const controlMapperTests = describe("ControlMapper", () => {
    ...
    beforeEach(() => {
        ...
        mapper = new ControlMapper(repository, ExampleControlBase, (setting) => new ExampleClientSetting(setting), ExampleDefaultControl, ExampleDefaultFieldControl);
    });
    ...
    it("Should be constructed with all parameters", () => {
        const newMapper = new ControlMapper(repository, ExampleControlBase, (setting) => new ExampleClientSetting(setting), ExampleDefaultControl, ExampleDefaultFieldControl);
        expect(newMapper).to.be.instanceof(ControlMapper);
    });
