...
export const flatIconTests: Mocha.Suite = describe('Icon component', () => {
  ...
  it('Should render without crashing', () => {
    c = renderer.create(<FlatIcon iconName="workspace" />)
  })
  it('Should render without crashing with fontSize', () => {
    c = renderer.create(<FlatIcon fontSize="default" iconName="workspace" />)
  })
  it('Should render without crashing with color', () => {
    c = renderer.create(<FlatIcon color="primary" iconName="workspace" />)
  })
  it('Should render without crashing with classes', () => {
    c = renderer.create(<FlatIcon classes={{}} iconName="workspace" />)
  })
  it('Should render without crashing with styles', () => {
    c = renderer.create(<FlatIcon style={{}} iconName="workspace" />)
  })
  it('Should render without crashing with onClick', () => {
    c = renderer.create(<FlatIcon onClick={e => console.log(e.target)} iconName="workspace" />)
  })
  it('Should render without crashing with children component', () => {
    c = renderer.create(
      <FlatIcon onClick={e => console.log(e.target)} iconName="workspace">
