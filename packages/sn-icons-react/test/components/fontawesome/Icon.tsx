...
export const fontawesomeIconTests: Mocha.Suite = describe('Icon component', () => {
  ...
  it('Should render without crashing', () => {
    c = renderer.create(<FontAwesomeIcon iconName="workspace" />)
  })
  it('Should render without crashing with fontSize', () => {
    c = renderer.create(<FontAwesomeIcon fontSize="default" iconName="workspace" />)
  })
  it('Should render without crashing with color', () => {
    c = renderer.create(<FontAwesomeIcon color="primary" iconName="workspace" />)
  })
  it('Should render without crashing with classes', () => {
    c = renderer.create(<FontAwesomeIcon classes={{}} iconName="workspace" />)
  })
  it('Should render without crashing with styles', () => {
    c = renderer.create(<FontAwesomeIcon style={{}} iconName="workspace" />)
  })
  it('Should render without crashing with onClick', () => {
    c = renderer.create(<FontAwesomeIcon onClick={e => console.log(e.target)} iconName="workspace" />)
  })
  it('Should render without crashing with children component', () => {
    c = renderer.create(
      <FontAwesomeIcon onClick={e => console.log(e.target)} iconName="workspace">
