...
export const imageIconTests: Mocha.Suite = describe('Icon component', () => {
  ...
  it('Should render without crashing', () => {
    c = renderer.create(<ImageIcon size={16} style={{ marginLeft: 2 }} iconName="workspace" />)
  })
  it('Should render without crashing without size param', () => {
    c = renderer.create(<ImageIcon iconName="workspace" />)
  })
  it('Should render without crashing with onClick param', () => {
    c = renderer.create(<ImageIcon onClick={e => console.log(e.target)} iconName="workspace" />)
  })
  it('Should render without crashing with overlay', () => {
    c = renderer.create(
      <ImageIcon iconName="workspace">
