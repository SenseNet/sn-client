...
export const mapStateToProps = (state: RootReducerType) => {
  return {
    title: state.sensenetDocumentViewer.localization.toggleThumbnails,
    isVisible: state.sensenetDocumentViewer.viewer.showThumbnails,
  }
}
 ...
 */
export const ToggleThumbnailsComponent: React.FunctionComponent<
...
> = props => (
  <ToggleBase {...props}>
    <svg
      ...
      fill={props.isVisible ? styles.colors.icon.active : styles.colors.icon.inactive}
