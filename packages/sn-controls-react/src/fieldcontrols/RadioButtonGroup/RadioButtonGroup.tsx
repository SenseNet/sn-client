...
import { styles } from './RadioButtonGroupStyles'

/**
 * Interface for RadioButton properties
 */
export interface RadioButtonGroupProps extends IReactClientFieldSetting, IClientFieldSetting, IChoiceFieldSetting { 
    onChange: Function
}
