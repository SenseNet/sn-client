 ...
 */
export const SwitcherControl: React.FC<ReactClientFieldSetting<FieldSetting>> = (props) => {
  const initialState =
    ...
    default:
      return (
        <Grid component={Typography} container alignItems="center" spacing={1}>
          ...
          <Grid item>
            {props.fieldValue != null ? (
              <Switcher size="small" checked={value} style={{ cursor: 'default', pointerEvents: 'none' }} />
            ) : (
              'No value set'
            )}
          </Grid>
