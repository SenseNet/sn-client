 ...
 */
export interface ShortTextProps<T extends GenericContent, K extends keyof T> extends ReactClientFieldSettingProps<T, K>, ReactClientFieldSetting<T, K>, ReactShortTextFieldSetting<T, K> { }
/**
 * Interface for ShortText properties
 */
 ...
 */
@Radium
export class ShortText<T extends GenericContent, K extends keyof T> extends Component<ShortTextProps<T, K>, ShortTextState> {
    /**
     * constructor
     * @param {object} props
     */
